...
async function run() {
  ...
  console.log('Staging updated blog details...');
  ...
  await git.commit({
    ...
    message: 'fix: improve blog parser for ordered lists and bold tags, add bottom CTA and right sidebar for company contacts'
  });
