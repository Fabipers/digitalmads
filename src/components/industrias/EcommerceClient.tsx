    ...
    <div className="min-h-screen bg-[#fafafc] text-[#111113] relative font-sans">
      ...
      <section className="relative pt-16 pb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold tracking-tight leading-none text-gray-900">
            Inteligencia Artificial para <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">E-commerce y Retail</span>
          </h1>
      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-12 shadow-sm">
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900">Conversión Optimizada con Modelos Generativos</h2>
            <p className="text-gray-600 leading-relaxed text-sm md:text-base font-light">
              El retail y comercio electrónico modernos demandan experiencias hiper-personalizadas y respuestas instantáneas. Diseñamos e implementamos agentes inteligentes que guían al cliente en su decisión de compra, responden dudas complejas y automatizan flujos operativos críticos de inventario y ERPs locales.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-8 shadow-sm">
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-display font-bold text-gray-900">Impulsa tu Tienda Online</h3>
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-wider text-gray-600 font-semibold" htmlFor="message">Cuéntanos sobre tu tienda o retail</label>
                  <textarea
                    id="message"
                    name="message"
                    rows={4}
      ...
      <footer className="py-12 border-t border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-gray-500 text-sm mb-8">
          ...
          <div className="space-y-2">
            <span className="text-xs uppercase font-bold text-gray-700 tracking-wider">Industrias</span>
            <ul className="space-y-1.5 text-xs">
              <li><a href="/industrias/ecommerce" className="hover:text-gray-900 transition-colors">E-commerce</a></li>
              <li><a href="/industrias/fintech" className="hover:text-gray-900 transition-colors">Fintech</a></li>
              <li><a href="/industrias/salud" className="hover:text-gray-900 transition-colors">Salud</a></li>
            </ul>
          </div>
