      ...
      <section className="relative pt-16 pb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold tracking-tight leading-none text-gray-900">
            Integración de IA en CRMs <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">(HubSpot, Salesforce)</span>
          </h1>

          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-light">
            Conectamos modelos de lenguaje y flujos automáticos RAG con tu plataforma de ventas para gestionar prospectos de forma autónoma.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-12 shadow-sm">
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900">Sincronización Inteligente de Ventas</h2>
            <p className="text-gray-600 leading-relaxed text-sm md:text-base font-light">
              Mapeamos y enlazamos de manera estructurada las APIs de HubSpot, Salesforce o Pipedrive. Diseñamos disparadores automáticos que activan agentes conversacionales de lenguaje natural en el instante en que un lead calificado entra en tu embudo, manteniendo los datos del cliente actualizados y eliminando el trabajo manual de captura de información.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
            {integrationFeatures.map((feat, idx) => (
              <div key={idx} className="bg-gray-50 border border-gray-100 p-6 rounded-2xl space-y-3">
                <h3 className="text-lg font-display font-bold text-gray-900">{feat.title}</h3>
                <p className="text-gray-600 text-xs md:text-sm leading-relaxed font-light">{feat.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-8 shadow-sm">
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-display font-bold text-gray-900">Solicita Integración CRM</h3>
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-wider text-gray-600 font-semibold" htmlFor="message">Cuéntanos sobre tu CRM e integraciones actuales</label>
                  <textarea
                    id="message"
                    name="message"
                    rows={4}
