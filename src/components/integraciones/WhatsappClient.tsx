      ...
      <section className="relative pt-16 pb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold tracking-tight leading-none text-gray-900">
            Agentes de Inteligencia Artificial para <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600">WhatsApp Business</span>
          </h1>
      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-12 shadow-sm">
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900">IA Inteligente con Enfoque RAG</h2>
            <p className="text-gray-600 leading-relaxed text-sm md:text-base font-light">
              Los bots tradicionales basados en reglas limitan a tus usuarios con menús estáticos que suelen causar frustración. Diseñamos agentes híbridos entrenados con la base de conocimientos de tu empresa (RAG) que responden de forma natural y fluida, ofreciendo la misma calidad que un consultor de ventas humano directo en el canal de mensajería favorito de tus clientes.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 space-y-8 shadow-sm">
            <div className="text-center space-y-4">
              <h3 className="text-3xl md:text-4xl font-display font-bold text-gray-900">Lleva la IA a WhatsApp</h3>
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-wider text-gray-600 font-semibold" htmlFor="message">Cuéntanos sobre tus objetivos en WhatsApp</label>
                  <textarea
                    id="message"
                    name="message"
                    rows={4}
