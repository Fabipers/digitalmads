...
export default function AuditoriaClient() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      company: "AI Audit Lead",
      needs: "Auditoría de Inteligencia Artificial",
          ...
          <div className="glass-card rounded-3xl border border-white/10 p-8 md:p-12 space-y-8">
            ...
            {formSubmitted ? (
              <div className="p-6 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl text-center space-y-2">
                ...
                <p className="text-gray-400 text-sm">Nos pondremos en contacto contigo de inmediato (en menos de 24h) para coordinar el acceso a la auditoría preliminar.</p>
              </div>
            ) : (
