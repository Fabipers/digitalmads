        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 text-center lg:text-left space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold tracking-tight leading-none">
              Transformamos tu empresa con <span className="text-gradient-purple-cyan glow-purple">Inteligencia Artificial</span>
            </h1>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="glass rounded-xl border border-white/5 overflow-hidden">
                ...
                {openFaq === idx && (
                  <div className="px-6 pb-6 text-gray-400 text-sm md:text-base leading-relaxed border-t border-white/5 pt-4 animate-fade-in">
                    {faq.answer}
                  </div>
                )}
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-black/30 border border-white/10 focus:border-purple-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-purple-500 text-white placeholder-gray-600 transition-colors"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="needs"
                      required
                      className="w-full px-4 py-3 bg-[#0a0a0f] border border-white/10 focus:border-purple-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-purple-500 text-white transition-colors"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-black/30 border border-white/10 focus:border-purple-500 rounded-xl focus:outline-none focus:ring-1 focus:ring-purple-500 text-white placeholder-gray-600 transition-colors resize-none"
                  />
                </div>
