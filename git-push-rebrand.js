...
async function run() {
  ...
  console.log('Staging all files for Tech Light Mode Rebranding...');
  ...
  await git.commit({
    ...
    message: 'feat: streamline header navigation with categorized dropdowns, convert global UI to tech light mode, and mandate phone field in workflows'
  });
